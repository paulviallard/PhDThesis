...
def main():
    ...
    arg_parser = ArgumentParser(
        description="Generate credit dataset")
    ...
    if(not(os.path.exists("data-credit/"))
       or not(os.path.exists("data-credit/credit.data"))):
        ...
        f = open("data-credit/credit.data", "wb")
        f.write(r.content)
        f.close()
    ...
    save("credit.h5", input_train, input_test, label_train, label_test)
