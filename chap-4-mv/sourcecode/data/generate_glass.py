...
def main():
    ...
    arg_parser = ArgumentParser(
        description="Generate glass dataset")
    ...
    if(not(os.path.exists("data-glass/"))
       or not(os.path.exists("data-glass/glass.data"))):
        ...
        r = requests.get(
            ...
            + "glass.data", allow_redirects=True)
        f = open("data-glass/glass.data", "wb")
        f.write(r.content)
        f.close()
    ...
    save("glass.h5", input_train, input_test, label_train, label_test)
