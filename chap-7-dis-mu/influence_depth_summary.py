...
measure_dict = {"dist_fro": r"\distfro", "dist_l2": r"\distltwo",
                ...
                "param_norm-aug": r"\paramnormaug",
                "path_norm-aug": r"\pathnormaug", "sum_fro-aug": r"\sumfroaug",
                "zero-aug": r"\zeroaug"}

dataset_dict = {"mnist": "MNIST", "fashion": "FashionMNIST"}

measure_dataset_list = [("zero", "mnist"), ("param_norm", "mnist"),
                        ("path_norm", "mnist"), ("zero", "fashion"),
                        ("param_norm", "fashion"), ("path_norm", "fashion")]

# --------------------------------------------------------------------------- #

fig, ax_list = plt.subplots(3, 2, figsize=((2*5.0, 5*3.0)))

i = 0
for measure, dataset in measure_dataset_list:
...
fig.savefig("figures/influence_depth/influence_depth_summary.pdf",
            bbox_inches="tight")
plt.close(fig)
